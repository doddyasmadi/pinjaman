...
namespace sahabat_umkm {
  ...
  public partial class m_news : DbContext {
    ...
    public m_news(DbContextOptions<m_news> options) :
        base(options) {
      OnCreated();
    }
    ...
    public virtual DbSet<m_agama> m_agama {
      get;
      set;
    }

    public virtual DbSet<m_golongan_darah> m_golongan_darah {
      get;
      set;
    }

    public virtual DbSet<m_jenjang_pendidikan> m_jenjang_pendidikan {
      get;
      set;
    }

    public virtual DbSet<m_jenis_bidang_usaha> m_jenis_bidang_usaha {
      get;
      set;
    }

    public virtual DbSet<m_pilihan_omzet> m_pilihan_omzet {
      get;
      set;
    }

    public virtual DbSet<t_data_anggota> t_data_anggota {
      get;
      set;
    }

    public virtual DbSet<t_data_usaha> t_data_usaha {
      get;
      set;
    }

    public virtual DbSet<t_posting> t_posting {
      get;
      set;
    }
    ...
    public virtual DbSet<t_hak_kekayaan_intelektual> t_hak_kekayaan_intelektual {
      get;
      set;
    }

    public virtual DbSet<t_pendirian_legalitas> t_pendirian_legalitas {
      get;
      set;
    }

    public virtual DbSet<t_data_pemegang_saham> t_data_pemegang_saham {
      get;
      set;
    }

    public virtual DbSet<t_info_bekraf> t_info_bekraf {
      get;
      set;
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
      ...
      this.t_hak_kekayaan_intelektualMapping(modelBuilder);
      this.Customizet_hak_kekayaan_intelektualMapping(modelBuilder);

      this.t_pendirian_legalitasMapping(modelBuilder);
      this.Customizet_pendirian_legalitasMapping(modelBuilder);

      this.t_data_pemegang_sahamMapping(modelBuilder);
      this.Customizet_data_pemegang_sahamMapping(modelBuilder);

      this.t_info_bekrafMapping(modelBuilder);
      this.Customizet_info_bekrafMapping(modelBuilder);
    ...
    private void t_data_anggotaMapping(ModelBuilder modelBuilder) {
      ...
      modelBuilder.Entity<t_data_anggota>().Property<bool>(x => x.kesediaan_mendaftar_sebagai_anggota).HasColumnName(@"kesediaan_mendaftar_sebagai_anggota").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_data_anggota>().Property<System.DateTime>(x => x.tanggal_pendaftaran_anggota).HasColumnName(@"tanggal_pendaftaran_anggota").IsRequired().ValueGeneratedOnAdd();
    ...
    private void t_postingMapping(ModelBuilder modelBuilder) {
      ...
      modelBuilder.Entity<t_posting>().Property<string>(x => x.thumbnail_posting).HasColumnName(@"thumbnail_posting").IsRequired().ValueGeneratedNever();
    ...
    #region t_hak_kekayaan_intelektual Mapping

    private void t_hak_kekayaan_intelektualMapping(ModelBuilder modelBuilder) {
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().ToTable(@"t_hak_kekayaan_intelektual");
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<int>(x => x.t_hak_kekayaan_intelektual_id).HasColumnName(@"t_hak_kekayaan_intelektual_id").IsRequired().ValueGeneratedOnAdd();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<string>(x => x.nama_hak_kekayaan_intelektual).HasColumnName(@"nama_hak_kekayaan_intelektual").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<string>(x => x.penjelasan_hak_kekayaan_intelektual).HasColumnName(@"penjelasan_hak_kekayaan_intelektual").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<string>(x => x.definisi_hak_kekayaan_intelektual).HasColumnName(@"definisi_hak_kekayaan_intelektual").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<string>(x => x.konsep_keuangan_usaha).HasColumnName(@"konsep_keuangan_usaha").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<string>(x => x.pernah_melakukan_kredit_pinjaman).HasColumnName(@"pernah_melakukan_kredit_pinjaman").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<string>(x => x.pernah_mendapat_bantuan_pemerintah_swasta).HasColumnName(@"pernah_mendapat_bantuan_pemerintah_swasta").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<string>(x => x.penjelasan_tempat_usaha).HasColumnName(@"penjelasan_tempat_usaha").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<string>(x => x.kendala_saat_menjalankan_usaha).HasColumnName(@"kendala_saat_menjalankan_usaha").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().Property<int>(x => x.t_data_usaha_id).HasColumnName(@"t_data_usaha_id").ValueGeneratedNever();
      modelBuilder.Entity<t_hak_kekayaan_intelektual>().HasKey(@"t_hak_kekayaan_intelektual_id");
    }

    partial void Customizet_hak_kekayaan_intelektualMapping(ModelBuilder modelBuilder);

    #endregion

    #region t_pendirian_legalitas Mapping

    private void t_pendirian_legalitasMapping(ModelBuilder modelBuilder) {
      modelBuilder.Entity<t_pendirian_legalitas>().ToTable(@"t_pendirian_legalitas");
      modelBuilder.Entity<t_pendirian_legalitas>().Property<int>(x => x.t_pendirian_legalitas_id).HasColumnName(@"t_pendirian_legalitas_id").IsRequired().ValueGeneratedOnAdd();
      modelBuilder.Entity<t_pendirian_legalitas>().Property<string>(x => x.usulan_nama_perusahaan).HasColumnName(@"usulan_nama_perusahaan").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_pendirian_legalitas>().Property<string>(x => x.surat_keterangan_domisili_usaha).HasColumnName(@"surat_keterangan_domisili_usaha").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_pendirian_legalitas>().Property<string>(x => x.penjelasan_domisili_usaha).HasColumnName(@"penjelasan_domisili_usaha").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_pendirian_legalitas>().Property<int>(x => x.t_data_usaha_id).HasColumnName(@"t_data_usaha_id").ValueGeneratedNever();
      modelBuilder.Entity<t_pendirian_legalitas>().HasKey(@"t_pendirian_legalitas_id");
    }

    partial void Customizet_pendirian_legalitasMapping(ModelBuilder modelBuilder);

    #endregion

    #region t_data_pemegang_saham Mapping

    private void t_data_pemegang_sahamMapping(ModelBuilder modelBuilder) {
      modelBuilder.Entity<t_data_pemegang_saham>().ToTable(@"t_data_pemegang_saham");
      modelBuilder.Entity<t_data_pemegang_saham>().Property<int>(x => x.t_data_pemegang_saham_id).HasColumnName(@"t_data_pemegang_saham_id").IsRequired().ValueGeneratedOnAdd();
      modelBuilder.Entity<t_data_pemegang_saham>().Property<string>(x => x.ktp_pemegang_saham).HasColumnName(@"ktp_pemegang_saham").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_data_pemegang_saham>().Property<string>(x => x.npwp_pemegang_saham).HasColumnName(@"npwp_pemegang_saham").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_data_pemegang_saham>().Property<string>(x => x.persentase_saham).HasColumnName(@"persentase_saham").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_data_pemegang_saham>().Property<int>(x => x.t_data_usaha_id).HasColumnName(@"t_data_usaha_id").ValueGeneratedNever();
      modelBuilder.Entity<t_data_pemegang_saham>().HasKey(@"t_data_pemegang_saham_id");
    }

    partial void Customizet_data_pemegang_sahamMapping(ModelBuilder modelBuilder);

    #endregion

    #region t_info_bekraf Mapping

    private void t_info_bekrafMapping(ModelBuilder modelBuilder) {
      modelBuilder.Entity<t_info_bekraf>().ToTable(@"t_info_bekraf");
      modelBuilder.Entity<t_info_bekraf>().Property<int>(x => x.t_info_bekraf_id).HasColumnName(@"t_info_bekraf_id").IsRequired().ValueGeneratedOnAdd();
      modelBuilder.Entity<t_info_bekraf>().Property<string>(x => x.kota_event_bekraf).HasColumnName(@"kota_event_bekraf").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_info_bekraf>().Property<string>(x => x.publikasi_event_bekraf).HasColumnName(@"publikasi_event_bekraf").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_info_bekraf>().Property<string>(x => x.keahlian_khusus).HasColumnName(@"keahlian_khusus").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_info_bekraf>().Property<bool>(x => x.tahu_bekraf).HasColumnName(@"tahu_bekraf").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_info_bekraf>().Property<string>(x => x.deskripsikan_tentang_bekraf).HasColumnName(@"deskripsikan_tentang_bekraf").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_info_bekraf>().Property<string>(x => x.harapan_terhadap_bekraf).HasColumnName(@"harapan_terhadap_bekraf").IsRequired().ValueGeneratedNever();
      modelBuilder.Entity<t_info_bekraf>().Property<int>(x => x.t_data_anggota_id).HasColumnName(@"t_data_anggota_id").ValueGeneratedNever();
      modelBuilder.Entity<t_info_bekraf>().HasKey(@"t_info_bekraf_id");
    }

    partial void Customizet_info_bekrafMapping(ModelBuilder modelBuilder);
    ...
    private void RelationshipsMapping(ModelBuilder modelBuilder) {
      ...
      modelBuilder.Entity<t_data_anggota>().HasMany(x => x.t_info_bekraf).WithOne(op => op.t_data_anggota).IsRequired(true).HasForeignKey(@"t_data_anggota_id");
      ...
      modelBuilder.Entity<t_data_usaha>().HasMany(x => x.t_hak_kekayaan_intelektual).WithOne(op => op.t_data_usaha).IsRequired(true).HasForeignKey(@"t_data_usaha_id");
      modelBuilder.Entity<t_data_usaha>().HasMany(x => x.t_pendirian_legalitas).WithOne(op => op.t_data_usaha).IsRequired(true).HasForeignKey(@"t_data_usaha_id");
      modelBuilder.Entity<t_data_usaha>().HasMany(x => x.t_data_pemegang_saham).WithOne(op => op.t_data_usaha).IsRequired(true).HasForeignKey(@"t_data_usaha_id");
      ...
      #region t_hak_kekayaan_intelektual Navigation properties

      modelBuilder.Entity<t_hak_kekayaan_intelektual>().HasOne(x => x.t_data_usaha).WithMany(op => op.t_hak_kekayaan_intelektual).IsRequired(true).HasForeignKey(@"t_data_usaha_id");

      #endregion

      #region t_pendirian_legalitas Navigation properties

      modelBuilder.Entity<t_pendirian_legalitas>().HasOne(x => x.t_data_usaha).WithMany(op => op.t_pendirian_legalitas).IsRequired(true).HasForeignKey(@"t_data_usaha_id");

      #endregion

      #region t_data_pemegang_saham Navigation properties

      modelBuilder.Entity<t_data_pemegang_saham>().HasOne(x => x.t_data_usaha).WithMany(op => op.t_data_pemegang_saham).IsRequired(true).HasForeignKey(@"t_data_usaha_id");

      #endregion

      #region t_info_bekraf Navigation properties

      modelBuilder.Entity<t_info_bekraf>().HasOne(x => x.t_data_anggota).WithMany(op => op.t_info_bekraf).IsRequired(true).HasForeignKey(@"t_data_anggota_id");
