...
namespace sahabat_umkm
{
    ...
    public partial class m_news_context : DbContext
    {
        ...
        {
            modelBuilder.Entity<m_jenis_bidang_usaha>().ToTable(@"m_jenis_bidang_usahas");
        ...
        {
            modelBuilder.Entity<m_pilihan_omzet>().ToTable(@"m_pilihan_omzets");
        ...
        {
            modelBuilder.Entity<t_data_anggota>().ToTable(@"t_data_anggotas");
        ...
        {
            modelBuilder.Entity<t_data_usaha>().ToTable(@"t_data_usahas");
