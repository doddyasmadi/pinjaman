      ...
      if (db_server == "SQLServer") {
        ...
        if (type == "Access") {
          connection = "Server=localhost;Port=30000;Database=sahabat_umkm;Uid=root;Pwd=GL-System123;"; //MariaDB
                                                                                                       //connection = "Server=localhost;Port=3306;Database=GLSDashboard_Access;Uid=root;Pwd=;"; //MySQL
        }
        else if (type == "StarSchema") {
          connection = "Server=localhost;Port=30000;Database=sahabat_umkm;Uid=root;Pwd=GL-System123;"; //MariaDB
                                                                                                       //connection = "Server=localhost;Port=3306;Database=GLSDashboard_StarSchema;Uid=root;Pwd=;"; //MySQL
        }
      }
      return connection;
    }
